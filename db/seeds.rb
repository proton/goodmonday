...
category_names = ['Автомобили', 'Азартные игры', 'Банки и Финансы', 'Досуг', 'Другое', 'Загрузки', 'Знакомства', 'Игры', 'Интернет-магазины', 'Интернет-решения', 'Информационные товары', 'Красота и здоровье', 'Купоны и скидки', 'Образование', 'Работа и Карьера', 'Развлечения', 'Спорт', 'Строительство и ремонт', 'Туризм и Отдых', 'Услуги', 'Изотерика и Психология', 'Для взрослых (Adult)']
